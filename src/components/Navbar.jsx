    ...
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-3">
      <nav className="mx-auto max-w-6xl rounded-2xl border border-white/10 bg-black/40 px-5 py-2 shadow-2xl shadow-black/20 backdrop-blur-xl">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-white p-0.5 shadow-md shadow-white/20 transition-transform duration-300 group-hover:scale-105">
              <img
